...
int main()
{
    ...
    // load textures
    // -------------
    unsigned int treeTexture = loadTexture(FileSystem::getPath("resources/objects/tree/bark1Normal.png").c_str());
    ...
    unsigned char *data = stbi_load(FileSystem::getPath("resources/textures/dirt_ground_basecolor.png").c_str(), &width, &height, &nrChannels, 0);
    if (data)
    {
