...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        terrainShader.setMat4("model1", model1);
        terrainShader.setMat4("view1", view1);
        terrainShader.setMat4("projection1", projection1);
        ...
        terrainShader.setFloat("material.shininess", 128.0f);
